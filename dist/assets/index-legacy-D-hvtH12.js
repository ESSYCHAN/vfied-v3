...
/**
			 ...
			 * limitations under the License.
			 */
class ie{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(e=>{if(function(e){const t=e.getComponent();return"VERSION"===(null==t?void 0:t.type)}(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null}).filter(e=>e).join(" ")}}const re="@firebase/app",se="0.10.13",oe=new F("@firebase/app"),ae="@firebase/app-compat",ce="@firebase/analytics-compat",le="@firebase/analytics",ue="@firebase/app-check-compat",he="@firebase/app-check",de="@firebase/auth",fe="@firebase/auth-compat",pe="@firebase/database",ge="@firebase/data-connect",me="@firebase/database-compat",ve="@firebase/functions",ye="@firebase/functions-compat",we="@firebase/installations",be="@firebase/installations-compat",Ie="@firebase/messaging",Ee="@firebase/messaging-compat",Te="@firebase/performance",_e="@firebase/performance-compat",Se="@firebase/remote-config",ke="@firebase/remote-config-compat",Ce="@firebase/storage",Ae="@firebase/storage-compat",xe="@firebase/firestore",Ne="@firebase/vertexai-preview",De="@firebase/firestore-compat",Oe="firebase",Re="[DEFAULT]",Pe={[re]:"fire-core",[ae]:"fire-core-compat",[le]:"fire-analytics",[ce]:"fire-analytics-compat",[he]:"fire-app-check",[ue]:"fire-app-check-compat",[de]:"fire-auth",[fe]:"fire-auth-compat",[pe]:"fire-rtdb",[ge]:"fire-data-connect",[me]:"fire-rtdb-compat",[ve]:"fire-fn",[ye]:"fire-fn-compat",[we]:"fire-iid",[be]:"fire-iid-compat",[Ie]:"fire-fcm",[Ee]:"fire-fcm-compat",[Te]:"fire-perf",[_e]:"fire-perf-compat",[Se]:"fire-rc",[ke]:"fire-rc-compat",[Ce]:"fire-gcs",[Ae]:"fire-gcs-compat",[xe]:"fire-fst",[De]:"fire-fst-compat",[Ne]:"fire-vertex","fire-js":"fire-js",[Oe]:"fire-js-all"},Le=new Map,Me=new Map,Ue=new Map;function Fe(e,t){try{e.container.addComponent(t)}catch(n){oe.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function je(e){const t=e.name;if(Ue.has(t))return oe.debug(`There were multiple attempts to register component ${t}.`),!1;Ue.set(t,e);for(const n of Le.values())Fe(n,e);for(const n of Me.values())Fe(n,e);return!0}function Ve(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}function $e(e){return void 0!==e.settings}
/**
			 * @license
			 * Copyright 2019 Google LLC
			 *
...
/**
			 ...
			 * See the License for the specific language governing permissions and
			 * limitations under the License.
			 */function So(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(xo(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(ko(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(Do(t))return"Blackberry";if(Oo(t))return"Webos";if(Co(t))return"Safari";if((t.includes("chrome/")||Ao(t))&&!t.includes("edge/"))return"Chrome";if(No(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=e.match(t);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function ko(e=p()){return/firefox\//i.test(e)}function Co(e=p()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function Ao(e=p()){return/crios\//i.test(e)}function xo(e=p()){return/iemobile/i.test(e)}function No(e=p()){return/android/i.test(e)}function Do(e=p()){return/blackberry/i.test(e)}function Oo(e=p()){return/webos/i.test(e)}function Ro(e=p()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function Po(){return function(){const e=p();return e.indexOf("MSIE ")>=0||e.indexOf("Trident/")>=0}()&&10===document.documentMode}function Lo(e=p()){return Ro(e)||No(e)||Oo(e)||Do(e)||/windows phone/i.test(e)||xo(e)}
/**
			 * @license
			 * Copyright 2020 Google LLC
			 *
...
/**
			 ...
			 * See the License for the specific language governing permissions and
			 * limitations under the License.
			 */(e);return Nc.test(t)?t:""}catch(e){return""}}function Oc(e){return`${e.appName}!${e.appId}`}
/**
			 * @license
			 * Copyright 2019 Google LLC
			 *
...
/**
			 ...
			 * limitations under the License.
			 */
const Uc="firebase-installations-store";let Fc=null;function jc(){return Fc||(Fc=X("firebase-installations-database",1,{upgrade:(e,t)=>{0===t&&e.createObjectStore(Uc)}})),Fc}async function Vc(e,t){const n=Oc(e),i=(await jc()).transaction(Uc,"readwrite"),r=i.objectStore(Uc),s=await r.get(n);return await r.put(t,n),await i.done,s&&s.fid===t.fid||Pc(e,t.fid),t}async function $c(e){const t=Oc(e),n=(await jc()).transaction(Uc,"readwrite");await n.objectStore(Uc).delete(t),await n.done}async function Bc(e,t){const n=Oc(e),i=(await jc()).transaction(Uc,"readwrite"),r=i.objectStore(Uc),s=await r.get(n),o=t(s);return void 0===o?await r.delete(n):await r.put(o,n),await i.done,!o||s&&s.fid===o.fid||Pc(e,o.fid),o}
/**
			 * @license
			 * Copyright 2019 Google LLC
			 *
