...
/**
			 ...
			 * limitations under the License.
			 */
class ie{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(e=>{if(function(e){const t=e.getComponent();return"VERSION"===(null==t?void 0:t.type)}(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null}).filter(e=>e).join(" ")}}const re="@firebase/app",se="0.10.13",oe=new F("@firebase/app"),ae="@firebase/app-compat",ce="@firebase/analytics-compat",le="@firebase/analytics",ue="@firebase/app-check-compat",he="@firebase/app-check",de="@firebase/auth",fe="@firebase/auth-compat",pe="@firebase/database",ge="@firebase/data-connect",me="@firebase/database-compat",ve="@firebase/functions",ye="@firebase/functions-compat",we="@firebase/installations",be="@firebase/installations-compat",Ie="@firebase/messaging",Ee="@firebase/messaging-compat",Te="@firebase/performance",_e="@firebase/performance-compat",Se="@firebase/remote-config",ke="@firebase/remote-config-compat",Ce="@firebase/storage",Ae="@firebase/storage-compat",xe="@firebase/firestore",Ne="@firebase/vertexai-preview",De="@firebase/firestore-compat",Re="firebase",Oe="[DEFAULT]",Pe={[re]:"fire-core",[ae]:"fire-core-compat",[le]:"fire-analytics",[ce]:"fire-analytics-compat",[he]:"fire-app-check",[ue]:"fire-app-check-compat",[de]:"fire-auth",[fe]:"fire-auth-compat",[pe]:"fire-rtdb",[ge]:"fire-data-connect",[me]:"fire-rtdb-compat",[ve]:"fire-fn",[ye]:"fire-fn-compat",[we]:"fire-iid",[be]:"fire-iid-compat",[Ie]:"fire-fcm",[Ee]:"fire-fcm-compat",[Te]:"fire-perf",[_e]:"fire-perf-compat",[Se]:"fire-rc",[ke]:"fire-rc-compat",[Ce]:"fire-gcs",[Ae]:"fire-gcs-compat",[xe]:"fire-fst",[De]:"fire-fst-compat",[Ne]:"fire-vertex","fire-js":"fire-js",[Re]:"fire-js-all"},Le=new Map,Me=new Map,Ue=new Map;function Fe(e,t){try{e.container.addComponent(t)}catch(n){oe.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function je(e){const t=e.name;if(Ue.has(t))return oe.debug(`There were multiple attempts to register component ${t}.`),!1;Ue.set(t,e);for(const n of Le.values())Fe(n,e);for(const n of Me.values())Fe(n,e);return!0}function Ve(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}function $e(e){return void 0!==e.settings}
/**
			 * @license
			 * Copyright 2019 Google LLC
			 *
...
/**
			 ...
			 * See the License for the specific language governing permissions and
			 * limitations under the License.
			 */const He="10.14.1";function qe(e,t={}){let n=e;"object"!=typeof t&&(t={name:t});const i=Object.assign({name:Oe,automaticDataCollectionEnabled:!1},t),r=i.name;if("string"!=typeof r||!r)throw Be.create("bad-app-name",{appName:String(r)});if(n||(n=h()),!n)throw Be.create("no-options");const s=Le.get(r);if(s){if(E(n,s.options)&&E(i,s.config))return s;throw Be.create("duplicate-app",{appName:r})}const o=new R(r);for(const c of Ue.values())o.addComponent(c);const a=new ze(n,i,o);return Le.set(r,a),a}function Ke(e=Oe){const t=Le.get(e);if(!t&&e===Oe&&h())return qe();if(!t)throw Be.create("no-app",{appName:e});return t}function Ge(e,t,n){var i;let r=null!==(i=Pe[e])&&void 0!==i?i:e;n&&(r+=`-${n}`);const s=r.match(/\s|\//),o=t.match(/\s|\//);if(s||o){const e=[`Unable to register library "${r}" with version "${t}":`];return s&&e.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&o&&e.push("and"),o&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),void oe.warn(e.join(" "))}je(new x(`${r}-version`,()=>({library:r,version:t}),"VERSION"))}
/**
			 * @license
			 * Copyright 2021 Google LLC
			 *
...
/**
			 ...
			 * See the License for the specific language governing permissions and
			 * limitations under the License.
			 */const yt=new F("@firebase/firestore");function wt(){return yt.logLevel}function bt(e,...t){if(yt.logLevel<=O.DEBUG){const n=t.map(Tt);yt.debug(`Firestore (${vt}): ${e}`,...n)}}function It(e,...t){if(yt.logLevel<=O.ERROR){const n=t.map(Tt);yt.error(`Firestore (${vt}): ${e}`,...n)}}function Et(e,...t){if(yt.logLevel<=O.WARN){const n=t.map(Tt);yt.warn(`Firestore (${vt}): ${e}`,...n)}}function Tt(e){if("string"==typeof e)return e;try{
/**
			    * @license
...
/**
			 ...
			 * See the License for the specific language governing permissions and
			 * limitations under the License.
			 */class oi{constructor(e,t=null,n=[],i=[],r=null,s=null,o=null){this.path=e,this.collectionGroup=t,this.orderBy=n,this.filters=i,this.limit=r,this.startAt=s,this.endAt=o,this.ue=null}}function ai(e,t=null,n=[],i=[],r=null,s=null,o=null){return new oi(e,t,n,i,r,s,o)}function ci(e){const t=kt(e);if(null===t.ue){let e=t.path.canonicalString();null!==t.collectionGroup&&(e+="|cg:"+t.collectionGroup),e+="|f:",e+=t.filters.map(e=>Qn(e)).join(","),e+="|ob:",e+=t.orderBy.map(e=>{return(t=e).field.canonicalString()+t.dir;var t}).join(","),nn(t.limit)||(e+="|l:",e+=t.limit),t.startAt&&(e+="|lb:",e+=t.startAt.inclusive?"b:":"a:",e+=t.startAt.position.map(e=>Dn(e)).join(",")),t.endAt&&(e+="|ub:",e+=t.endAt.inclusive?"a:":"b:",e+=t.endAt.position.map(e=>Dn(e)).join(",")),t.ue=e}return t.ue}function li(e,t){if(e.limit!==t.limit)return!1;if(e.orderBy.length!==t.orderBy.length)return!1;for(let n=0;n<e.orderBy.length;n++)if(!zn(e.orderBy[n],t.orderBy[n]))return!1;if(e.filters.length!==t.filters.length)return!1;for(let n=0;n<e.filters.length;n++)if(!Jn(e.filters[n],t.filters[n]))return!1;return e.collectionGroup===t.collectionGroup&&!!e.path.isEqual(t.path)&&!!$n(e.startAt,t.startAt)&&$n(e.endAt,t.endAt)}
/**
			 * @license
			 * Copyright 2017 Google LLC
			 *
...
/**
			 ...
			 * limitations under the License.
			 */
class Ri{constructor(){this._=void 0}}function Oi(e,t,n){return e instanceof Li?function(e,t){const n={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:e.seconds,nanos:e.nanoseconds}}}};return t&&wn(t)&&(t=bn(t)),t&&(n.fields.__previous_value__=t),{mapValue:n}}(n,t):e instanceof Mi?Ui(e,t):e instanceof Fi?ji(e,t):function(e,t){const n=function(e,t){return e instanceof Vi?function(e){return On(e)||!!(t=e)&&"doubleValue"in t;var t}(t)?t:{integerValue:0}:null}(e,t),i=$i(n)+$i(e.Pe);return On(n)&&On(e.Pe)?function(e){return{integerValue:""+e}}(i):
/**
			 * @license
			 * Copyright 2020 Google LLC
			 *
...
/**
			 ...
			 * See the License for the specific language governing permissions and
			 * limitations under the License.
			 */class Or{constructor(e,t,n,i){this.targetId=e,this.fromCache=t,this.$i=n,this.Ui=i}static Wi(e,t){let n=Ni(),i=Ni();for(const r of t.docChanges)switch(r.type){case 0:n=n.add(r.doc.key);break;case 1:i=i.add(r.doc.key)}return new Or(e,t.fromCache,n,i)}}
/**
			 * @license
			 * Copyright 2023 Google LLC
			 *
...
/**
			 ...
			 * limitations under the License.
			 */
Ge("firebase","10.14.1","app"),"function"==typeof SuppressedError&&SuppressedError;const Os=Rs,Ps=new b("auth","Firebase",{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}),Ls=new F("@firebase/auth");function Ms(e,...t){Ls.logLevel<=O.ERROR&&Ls.error(`Auth (${He}): ${e}`,...t)}
/**
			 * @license
			 * Copyright 2020 Google LLC
			 *
...
/**
			 ...
			 * See the License for the specific language governing permissions and
			 * limitations under the License.
			 */function So(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(xo(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(ko(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(Do(t))return"Blackberry";if(Ro(t))return"Webos";if(Co(t))return"Safari";if((t.includes("chrome/")||Ao(t))&&!t.includes("edge/"))return"Chrome";if(No(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=e.match(t);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function ko(e=p()){return/firefox\//i.test(e)}function Co(e=p()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function Ao(e=p()){return/crios\//i.test(e)}function xo(e=p()){return/iemobile/i.test(e)}function No(e=p()){return/android/i.test(e)}function Do(e=p()){return/blackberry/i.test(e)}function Ro(e=p()){return/webos/i.test(e)}function Oo(e=p()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function Po(){return function(){const e=p();return e.indexOf("MSIE ")>=0||e.indexOf("Trident/")>=0}()&&10===document.documentMode}function Lo(e=p()){return Oo(e)||No(e)||Ro(e)||Do(e)||/windows phone/i.test(e)||xo(e)}
/**
			 * @license
			 * Copyright 2020 Google LLC
			 *
...
/**
			 ...
			 * limitations under the License.
			 */
const Nc=/^[cdef][\w-]{21}$/;function Dc(){try{const e=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(e),e[0]=112+e[0]%16;const t=function(e){const t=(n=e,btoa(String.fromCharCode(...n)).replace(/\+/g,"-").replace(/\//g,"_"));var n;return t.substr(0,22)}
/**
			 * @license
			 * Copyright 2019 Google LLC
			 *
			 ...
			 * See the License for the specific language governing permissions and
			 * limitations under the License.
			 */(e);return Nc.test(t)?t:""}catch(e){return""}}function Rc(e){return`${e.appName}!${e.appId}`}
/**
			 * @license
			 * Copyright 2019 Google LLC
			 *
			 ...
			 * See the License for the specific language governing permissions and
			 * limitations under the License.
			 */const Oc=new Map;function Pc(e,t){const n=Rc(e);Lc(n,t),function(e,t){const n=(!Mc&&"BroadcastChannel"in self&&(Mc=new BroadcastChannel("[Firebase] FID Change"),Mc.onmessage=e=>{Lc(e.data.key,e.data.fid)}),Mc);n&&n.postMessage({key:e,fid:t}),0===Oc.size&&Mc&&(Mc.close(),Mc=null)}(n,t)}function Lc(e,t){const n=Oc.get(e);if(n)for(const i of n)i(t)}let Mc=null;
/**
			 * @license
			 * Copyright 2019 Google LLC
			 *
			 ...
			 * limitations under the License.
			 */
const Uc="firebase-installations-store";let Fc=null;function jc(){return Fc||(Fc=X("firebase-installations-database",1,{upgrade:(e,t)=>{0===t&&e.createObjectStore(Uc)}})),Fc}async function Vc(e,t){const n=Rc(e),i=(await jc()).transaction(Uc,"readwrite"),r=i.objectStore(Uc),s=await r.get(n);return await r.put(t,n),await i.done,s&&s.fid===t.fid||Pc(e,t.fid),t}async function $c(e){const t=Rc(e),n=(await jc()).transaction(Uc,"readwrite");await n.objectStore(Uc).delete(t),await n.done}async function Bc(e,t){const n=Rc(e),i=(await jc()).transaction(Uc,"readwrite"),r=i.objectStore(Uc),s=await r.get(n),o=t(s);return void 0===o?await r.delete(n):await r.put(o,n),await i.done,!o||s&&s.fid===o.fid||Pc(e,o.fid),o}
/**
			 * @license
			 * Copyright 2019 Google LLC
			 *
...
/**
			 ...
			 * limitations under the License.
			 */
function(e,t){const n=Ve(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(E(n.getOptions(),null!=t?t:{}))return e;Us(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:cc,persistence:[Sa,ca,ua]}),i=d("authTokenSyncURL");if(i&&"boolean"==typeof isSecureContext&&isSecureContext){const e=new URL(i,location.origin);if(location.origin===e.origin){const t=(r=e.toString(),async e=>{const t=e&&await e.getIdTokenResult(),n=t&&((new Date).getTime()-Date.parse(t.issuedAtTime))/1e3;if(n&&n>dc)return;const i=null==t?void 0:t.token;fc!==i&&(fc=i,await fetch(r,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))});!function(e,t,n){A(e).beforeAuthStateChanged(t,n)}(n,t,()=>t(n.currentUser)),function(e,t,n,i){A(e).onIdTokenChanged(t,n,i)}(n,e=>t(e))}}var r;const s=u("auth");s&&zo(n,`http://${s}`)}(Nl),function(e=Ke()){const t=Ve(e=A(e),nl);t.isInitialized()?t.getImmediate():function(e,t={}){const n=Ve(e,nl);if(n.isInitialized()){const e=n.getImmediate();if(E(t,n.getOptions()))return e;throw sl.create("already-initialized")}n.initialize({options:t})}(e)}(Nl),window.addEventListener("online",async()=>{try{await xs(Dl),console.log("🔥 Firebase: Back online")}catch(e){console.error("Firebase network enable error:",e)}}),window.addEventListener("offline",async()=>{try{await Ns(Dl),console.log("🔥 Firebase: Offline mode")}catch(e){console.error("Firebase network disable error:",e)}});try{console.log("🔥 Firebase initialized successfully with project:",xl.projectId)}catch(ou){console.error("Firebase initialization error:",ou)}const Rl=t.API_BASE;console.log("API_BASE ->",Rl||"(same-origin)");const Ol=[{name:"Sarah",comment:"🔥 Best ramen spot ever!",emoji:"🍜",avatar:"https://i.pravatar.cc/80?img=32"},{name:"James",comment:"💯 Always go for the sushi here",emoji:"🍣",avatar:"https://i.pravatar.cc/80?img=12"},{name:"Aisha",comment:"👌 Perfect comfort food when tired",emoji:"🍲",avatar:"https://i.pravatar.cc/80?img=58"}],Pl=[{food:{emoji:"🍜",name:"Tonkotsu Ramen"},friendMessage:"Warming and soothing — perfect for stressed vibes.",availabilityNote:"Try Koya Soho or Tonkotsu (open now)",culturalNote:"Ramen culture in London has exploded — Soho has great late-night bowls.",weatherNote:"Rainy/cold? Hot broth hits just right.",source:"local-fallback"},{food:{emoji:"🍣",name:"Sushi Set"},friendMessage:"Clean and fresh — light but satisfying.",availabilityNote:"Sushi Atelier or Kanada-Ya nearby",culturalNote:"Japanese spots cluster around Fitzrovia & Soho.",weatherNote:"Great choice when you want something not too heavy.",source:"local-fallback"},{food:{emoji:"🥙",name:"Mezze Plate"},friendMessage:"Shareable, bright flavors, and not heavy.",availabilityNote:"Check Arabica Borough or a local Levantine spot",culturalNote:"Londons Middle Eastern scene is strong — Borough & Edgware Road.",weatherNote:"Good in any weather; easy on the stomach.",source:"local-fallback"}];let Ll=[],Ml={},Ul=[];function Fl(e,t=!0){try{const n=e||document.getElementById("decide-button");if(!n)return;n.disabled=!!t;const i=document.getElementById("button-icon"),r=document.getElementById("button-text");t?(i&&(i.textContent="⏳"),r&&(r.textContent="Thinking…")):(i&&(i.textContent="🎯"),r&&(r.textContent="DECIDE FOR ME"))}catch(n){console.warn("setThinking failed:",n)}}async function jl(){const e=document.getElementById("decide-button");Fl(e,!0),function(){const e=Zl("suggestion-skeleton"),t=Zl("suggestion-result");e&&e.classList.remove("hidden"),t&&t.classList.add("hidden")}(),iu("Analyzing your mood, weather, and local options...");try{const e=document.getElementById("mood-input")?.value?.trim()||"hungry",t=Array.from(document.querySelectorAll(".diet-chip.active")).map(e=>e.dataset.diet),n=await fetch(`${Rl}/v1/recommend`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({location:{city:"London",country:"United Kingdom",country_code:"GB"},mood_text:e,dietary:t,budget:"medium",menu_source:"global_database"})});if(!n.ok){const e=await n.text();throw new Error(`HTTP ${n.status}: ${e}`)}const i=await n.json();if(!i.success)throw new Error(i.error||"Recommendation failed");Vl(Hl(i)),function({timeSavedMin:e=2}={}){const t=localStorage.getItem("vfied_stats"),n=t?JSON.parse(t):{totalDecisions:0,timeSaved:0};n.totalDecisions+=1,n.timeSaved+=e,localStorage.setItem("vfied_stats",JSON.stringify(n)),Xl()}({timeSavedMin:3})}catch(ou){console.error("Decision error:",ou),Yl(`Server unavailable: ${ou.message}`,"warn"),Vl(Hl((t=Pl)[Math.floor(Math.random()*t.length)])),iu("Using offline suggestion (server unavailable)")}finally{!function(){const e=Zl("suggestion-skeleton");e&&e.classList.add("hidden")}(),Fl(e,!1)}var t}function Vl(e){!function(e){const t=Zl(e);t&&t.classList.remove("hidden")}("suggestion-result"),eu("result-emoji",e.food?.emoji||"🍽️"),eu("result-name",e.food?.name||"Something delicious"),eu("result-description",e.friendMessage||e.reasoning||"Perfect for your mood!"),eu("restaurant-info",e.availabilityNote||""),tu("cultural-note",e.culturalNote?`<strong>🌍 Cultural insight</strong><br>${e.culturalNote}`:""),tu("personal-note",e.personalNote?`<strong>🧠 Personal note</strong><br>${e.personalNote}`:""),tu("weather-note",e.weatherNote?`<strong>🌤️ Weather</strong><br>${e.weatherNote}`:""),function(e){const t=Zl("social-signals");if(!t)return;let n="";e.socialSignal&&(n+=`\n      <div class="social-signal friend-signal">\n        <span class="signal-icon">👥</span>\n        <span class="signal-text">${e.socialSignal.message}</span>\n      </div>`),e.localSignal&&(n+=`\n      <div class="social-signal local-signal">\n        <span class="signal-icon">📍</span>\n        <span class="signal-text">${e.localSignal.message}</span>\n      </div>`),t.innerHTML=n}(e),iu("🎉 Perfect match found! How does this sound?")}function $l(){nu("suggestion-result"),iu("🎉 Decision made! Ready for your next food adventure."),Yl("✅ Enjoy your meal!","success")}function Bl(){nu("suggestion-result"),jl()}function zl(e){const t=Ol.find(t=>t.name===e);if(!t)return;Yl(`💬 Asking ${t.name}: "${t.comment}"`,"info");const n=Zl("mood-input");n&&("🍜"===t.emoji?n.value="need something warming and comforting":"🍣"===t.emoji?n.value="feeling adventurous, want something fresh":n.value="need comfort food")}function Hl(e){const t=(e.food?.name||"").toLowerCase();let n=Ol[Math.floor(Math.random()*Ol.length)];if((t.includes("ramen")||t.includes("noodle"))&&(n=Ol[0]),(t.includes("sushi")||t.includes("japanese"))&&(n=Ol[1]),e.socialSignal={type:"friend",friend:n,message:`${n.name}: "${n.comment}"`},Ll.length){const t=Ll[Math.floor(Math.random()*Ll.length)];e.localSignal={type:"local_list",list:t,message:`Popular in "${t.name}" (${t.area})`}}return e}function ql(e){const t=Ll.find(t=>t.name===e);if(!t)return;const n=Zl("mood-input");n&&(n.value=`want something from ${t.name} list in ${t.area}`),jl()}function Kl(){const e=Zl("travel-city-select")?.value||Object.keys(Ml)[0],t=(Ml[e]||[]).slice(0,10),n=Zl("travel-grid");n&&(n.innerHTML="",t.forEach(t=>{const i=document.createElement("div");i.className="travel-card",i.innerHTML=`\n      <div class="travel-emoji">${t.emoji}</div>\n      <div class="travel-body">\n        <div class="travel-title">${ru(t.name)}</div>\n        <div class="travel-note">${ru(t.note||"")}</div>\n      </div>\n    `,i.addEventListener("click",()=>Gl(e,t.name)),n.appendChild(i)}))}function Gl(e,t){const n=Zl("mood-input");n&&(n.value=`travel mode: try ${t} in ${e}`),jl()}function Wl(e){Yl(`🎪 ${e}\n(Integrate ticket link or detail view here)`,"info")}function Ql(e){window.open(`https://www.google.com/maps/search/?api=1&query=${e}`,"_blank")}function Jl(){const e=Zl("mood-input"),t=e?.value?.trim();if(!t)return Yl("🧠 Please enter your mood first!","warn");Yl("🧠 Mood analyzed — using it in your next suggestion!","info"),jl()}function Xl(){const e=localStorage.getItem("vfied_stats"),t=e?JSON.parse(e):{totalDecisions:0,timeSaved:0};eu("decisions-count",t.totalDecisions),eu("time-saved",t.timeSaved)}function Yl(e,t="info"){const n=Zl("vfied-toast-host");if(!n)return console.log(e);const i=document.createElement("div");i.className=`vfied-toast ${t}`,i.textContent=e,n.appendChild(i),requestAnimationFrame(()=>i.classList.add("show")),setTimeout(()=>{i.classList.remove("show"),setTimeout(()=>n.removeChild(i),250)},2600)}function Zl(e){return document.getElementById(e)}function eu(e,t){const n=Zl(e);n&&(n.textContent=t)}function tu(e,t){const n=Zl(e);n&&(n.innerHTML=t)}function nu(e){const t=Zl(e);t&&t.classList.add("hidden")}function iu(e){eu("context-info",e)}function ru(e){return String(e).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"}[e]))}function su(e){e&&(e.setAttribute("aria-hidden","true"),e.classList.remove("open"))}document.addEventListener("DOMContentLoaded",()=>{!function(){if(document.getElementById("vfied-runtime-styles"))return;const e="\n  #vfied-toast-host {\n    position: fixed; left: 50%; bottom: 24px; transform: translateX(-50%);\n    display: flex; flex-direction: column; gap: 8px; z-index: 9999; pointer-events: none;\n  }\n  .vfied-toast {\n    pointer-events: auto;\n    min-width: 240px; max-width: 92vw;\n    padding: 10px 14px; border-radius: 10px; backdrop-filter: blur(8px);\n    background: rgba(0,0,0,.65); color: #fff; font-weight: 600; font-size: 14px;\n    opacity: 0; transform: translateY(8px); transition: all .25s ease;\n    border: 1px solid rgba(255,255,255,.15);\n  }\n  .vfied-toast.show { opacity: 1; transform: translateY(0); }\n  .vfied-toast.success { background: rgba(34,197,94,.85); }\n  .vfied-toast.warn { background: rgba(245,158,11,.9); }\n  .vfied-toast.error { background: rgba(239,68,68,.9); }\n\n  .skeleton-card {\n    background: rgba(255,255,255,.12); border: 1px solid rgba(255,255,255,.18);\n    border-radius: 16px; padding: 18px; max-width: 420px; margin: 8px auto;\n  }\n  .sk-line {\n    height: 14px; margin: 10px 0;\n    background: linear-gradient(90deg, rgba(255,255,255,.15), rgba(255,255,255,.25), rgba(255,255,255,.15));\n    background-size: 200% 100%; animation: sk-shimmer 1.4s infinite;\n    border-radius: 8px;\n  }\n  .sk-emoji { height: 46px; width: 46px; border-radius: 50%; margin: 0 auto 10px; }\n  .sk-title { height: 18px; width: 70%; margin: 12px auto; }\n  .sk-sub { width: 90%; margin: 10px auto; }\n  .sk-sub.short { width: 60%; }\n  @keyframes sk-shimmer { 0% { background-position: 200% 0; } 100% { background-position: -200% 0; } }\n\n  /* Friend avatar chip (if your CSS doesn't already style it) */\n  .friend-chip { display:inline-flex; align-items:center; gap:8px; }\n  .friend-avatar { width:22px; height:22px; border-radius:50%; object-fit:cover; }\n  ",t=document.createElement("style");t.id="vfied-runtime-styles",t.textContent=e,document.head.appendChild(t)}(),function(){if(Zl("vfied-toast-host"))return;const e=document.createElement("div");e.id="vfied-toast-host",document.body.appendChild(e)}(),function(){const e=Zl("decide-button"),t=Zl("detect-mood-btn"),n=Zl("accept-btn"),i=Zl("try-again-btn"),r=Zl("insights-toggle");e&&e.addEventListener("click",jl),t&&t.addEventListener("click",Jl),n&&n.addEventListener("click",$l),i&&i.addEventListener("click",Bl),r&&r.addEventListener("click",()=>{const e=Zl("insights-content");e.classList.contains("hidden")?(e.classList.remove("hidden"),r.textContent="🤖 Hide insights ↑"):(e.classList.add("hidden"),r.textContent="🤖 Why this choice? ↓")});const s=Zl("see-more-gems"),o=Zl("gems-modal"),a=Zl("gems-modal-close");s&&s.addEventListener("click",()=>{var e;!function(){const e=Zl("gems-modal-list");e&&(e.innerHTML=Ll.map(e=>`\n      <li>\n        <span style="font-size:18px;margin-right:6px;">${e.emoji}</span>\n        <strong>${e.name}</strong> <span style="opacity:.8">• ${e.area}</span>\n      </li>`).join(""))}(),(e=o)&&(e.setAttribute("aria-hidden","false"),e.classList.add("open"))}),a&&a.addEventListener("click",()=>su(o)),o&&o.addEventListener("click",e=>{e.target===o&&su(o)})}(),document.querySelectorAll(".tab-btn").forEach(e=>{e.addEventListener("click",()=>{document.querySelectorAll(".tab-btn").forEach(e=>e.classList.remove("active")),e.classList.add("active");const t=e.dataset.tab;document.querySelectorAll(".tabpanel").forEach(e=>e.classList.add("hidden")),Zl(t)?.classList.remove("hidden")})}),function(){const e=Zl("friend-chips");e&&(e.innerHTML="",Ol.forEach(t=>{const n=document.createElement("button");n.className="friend-chip",n.innerHTML=`\n      <img class="friend-avatar" src="${t.avatar}" alt="${ru(t.name)}" />\n      <span>${t.emoji} <strong>${ru(t.name)}</strong></span>\n    `,n.addEventListener("click",()=>zl(t.name)),e.appendChild(n)}))}(),async function(){try{const e="/data/local_lists.json",t=await fetch(e,{cache:"no-store"});Ll=await t.json()}catch{Ll=[]}!function(){const e=Zl("local-gems-grid");if(!e)return;const t=Ll.slice(0,8);e.innerHTML="",t.forEach(t=>{const n=document.createElement("div");n.className="gem-card",n.innerHTML=`\n      <div class="gem-emoji">${t.emoji}</div>\n      <div class="gem-name">${ru(t.name)}</div>\n      <div class="gem-area">${ru(t.area)}</div>\n    `,n.addEventListener("click",()=>ql(t.name)),e.appendChild(n)})}()}(),async function(){try{const e="/data/travel_lists.json",t=await fetch(e,{cache:"no-store"});Ml=await t.json()}catch{Ml={}}(function(){const e=Zl("travel-city-select");if(!e)return;const t=Object.keys(Ml);e.innerHTML=t.map(e=>`<option value="${e}">${e}</option>`).join(""),e.addEventListener("change",()=>Kl())})(),Kl()}(),async function(){try{const e="/data/events.json",t=await fetch(e,{cache:"no-store"});Ul=await t.json()}catch{Ul=[]}!function(){const e=Zl("events-grid");e&&(e.innerHTML="",Ul.forEach(t=>{const n=document.createElement("div");n.className="event-card";const i=document.createElement("div");i.className="event-badge",i.textContent=t.emoji;const r=document.createElement("div");r.className="event-body";const s=document.createElement("div");s.className="event-title",s.textContent=t.title;const o=document.createElement("div");o.className="event-meta",o.textContent=`${t.date} • ${t.area} • ${t.price||"Free"}`;const a=document.createElement("div");a.className="event-cta";const c=document.createElement("button");c.className="insights-toggle",c.textContent="Details",c.addEventListener("click",()=>Wl(t.title));const l=document.createElement("button");l.className="insights-toggle",l.textContent="Directions",l.addEventListener("click",()=>Ql(encodeURIComponent(t.map||t.title))),a.append(c,l),r.append(s,o,a),n.append(i,r),e.appendChild(n)}))}()}(),Xl(),console.log("🚀 VFIED unified main loaded")}),window.VFIED={askFriend:zl,exploreGem:ql,tryTravel:Gl,goEvent:Wl,goMaps:Ql}}}});
//# sourceMappingURL=index-legacy-CTTgt5ZA.js.map
