function Yy(){import.meta.url,import("_").catch(()=>1),(async function*(){})().next()}(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const c of o.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&r(c)}).observe(document,{childList:!0,subtree:!0});function t(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(i){if(i.ep)return;i.ep=!0;const o=t(i);fetch(i.href,o)}})();const Pu=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1",ku=3049,Ou={API_BASE:Pu?"http://localhost:".concat(ku):"https://vfied-v3.onrender.com"};var ko={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hd(n){De(new Re("platform-logger",e=>new Ah(e),"PRIVATE")),De(new Re("heartbeat",e=>new cd(e),"PRIVATE")),we(Ri,Mo,n),we(Ri,Mo,"esm2017"),we("fire-js","")}hd("");var jo=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wr=new Or("@firebase/auth");function fp(n,...e){wr.logLevel<=V.WARN&&wr.warn("Auth (".concat(zt,"): ").concat(n),...e)}function lr(n,...e){wr.logLevel<=V.ERROR&&wr.error("Auth (".concat(zt,"): ").concat(n),...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Rn(n,e,t=!1){if(t)return e;try{return await e}catch(r){throw r instanceof Ce&&wp(r)&&n.auth.currentUser===n&&await n.auth.signOut(),r}}function wp({code:n}){return n==="auth/user-disabled"||n==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bp(n,e){const t=bt(n,"auth");if(t.isInitialized()){const i=t.getImmediate(),o=t.getOptions();if(Tn(o,e!=null?e:{}))return i;$e(i,"already-initialized")}return t.initialize({options:e})}function jp(n,e){const t=(e==null?void 0:e.persistence)||[],r=(Array.isArray(t)?t:[t]).map(Be);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function $p(n,e,t){const r=vs(n);D(r._canInitEmulator,r,"emulator-config-failed"),D(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const i=!1,o=tl(e),{host:c,port:u}=Hp(e),h=u===null?"":":".concat(u);r.config.emulator={url:"".concat(o,"//").concat(c).concat(h,"/")},r.settings.appVerificationDisabledForTesting=!0,r.emulatorConfig=Object.freeze({host:c,port:u,protocol:o.replace(":",""),options:Object.freeze({disableWarnings:i})}),qp()}function tl(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function Hp(n){const e=tl(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",i=/^(\[[^\]]+\])(:|$)/.exec(r);if(i){const o=i[1];return{host:o,port:Ia(r.substr(o.length+1))}}else{const[o,c]=r.split(":");return{host:o,port:Ia(c)}}}function Ia(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function qp(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ts extends nl{constructor(e){super("custom","custom"),this.params=e}_getIdTokenResponse(e){return Mt(e,this._buildIdpRequest())}_linkToIdToken(e,t){return Mt(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return Mt(e,this._buildIdpRequest())}_buildIdpRequest(e){const t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}}function fg(n){return Wp(n.auth,new Ts(n),n.bypassAuthState)}function pg(n){const{auth:e,user:t}=n;return D(t,e,"internal-error"),Kp(t,new Ts(n),n.bypassAuthState)}async function gg(n){const{auth:e,user:t}=n;return D(t,e,"internal-error"),Gp(t,new Ts(n),n.bypassAuthState)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yg="pendingRedirect",hr=new Map;class _g extends fl{constructor(e,t,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,r),this.eventId=null}async execute(){let e=hr.get(this.auth._key());if(!e){try{const r=await vg(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(t){e=()=>Promise.reject(t)}hr.set(this.auth._key(),e)}return this.bypassAuthState||hr.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function vg(n,e){const t=Tg(e),r=Eg(n);if(!await r._isAvailable())return!1;const i=await r._get(t)==="true";return await r._remove(t),i}function Ig(n,e){hr.set(n._key(),e)}function Eg(n){return Be(n._redirectPersistence)}function Tg(n){return ur(yg,n.config.apiKey,n.name)}async function wg(n,e,t=!1){if(Ze(n.app))return Promise.reject(_t(n));const r=vs(n),i=dg(r,e),c=await new _g(r,i,t).execute();return c&&!t&&(delete c.user._redirectEventId,await r._persistUserIfCurrent(c.user),await r._setRedirectUser(null,e)),c}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ml=1e4,yl="w:".concat(ws),_l="FIS_v2",lm="https://firebaseinstallations.googleapis.com/v1",um=3600*1e3,hm="installations",dm="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ym({appConfig:n,heartbeatServiceProvider:e},{fid:t}){const r=Il(n),i=wl(n),o=e.getImmediate({optional:!0});if(o){const f=await o.getHeartbeatsHeader();f&&i.append("x-firebase-client",f)}const c={fid:t,authVersion:_l,appId:n.appId,sdkVersion:yl},u={method:"POST",headers:i,body:JSON.stringify(c)},h=await Al(()=>fetch(r,u));if(h.ok){const f=await h.json();return{fid:f.fid||t,registrationStatus:2,refreshToken:f.refreshToken,authToken:El(f.authToken)}}else throw await Tl("Create Installation",h)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sl=new Map;function Rl(n,e){const t=xr(n);Cl(t,e),Tm(t,e)}function Cl(n,e){const t=Sl.get(n);if(t)for(const r of t)r(e)}function Tm(n,e){const t=wm();t&&t.postMessage({key:n,fid:e}),Am()}let pt=null;function wm(){return!pt&&"BroadcastChannel"in self&&(pt=new BroadcastChannel("[Firebase] FID Change"),pt.onmessage=n=>{Cl(n.data.key,n.data.fid)}),pt}function Am(){Sl.size===0&&pt&&(pt.close(),pt=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Iy{constructor(e){this.app=e}_delete(){return delete En[this.app.options.appId],Promise.resolve()}}let En={},Na=[];const La={};let Ti="dataLayer",Ey="gtag",Va,Ml,Ma=!1;function Ty(){const n=[];if(Qa()&&n.push("This is a browser extension environment."),Wu()||n.push("Cookies are not available."),n.length>0){const e=n.map((r,i)=>"(".concat(i+1,") ").concat(r)).join(" "),t=Te.create("invalid-analytics-context",{errorInfo:e});_e.warn(t.message)}}function wy(n,e,t){Ty();const r=n.options.appId;if(!r)throw Te.create("no-app-id");if(!n.options.apiKey)if(n.options.measurementId)_e.warn('The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID '.concat(n.options.measurementId,' provided in the "measurementId" field in the local Firebase config.'));else throw Te.create("no-api-key");if(En[r]!=null)throw Te.create("already-exists",{id:r});if(!Ma){ny(Ti);const{wrappedGtag:o,gtagCore:c}=oy(En,Na,La,Ti,Ey);Ml=o,Va=c,Ma=!0}return En[r]=vy(n,Na,La,e,Va,Ti,t),new Iy(n)}function Ay(n=Ki()){n=at(n);const e=bt(n,Pr);return e.isInitialized()?e.getImmediate():by(n)}function by(n,e={}){const t=bt(n,Pr);if(t.isInitialized()){const i=t.getImmediate();if(Tn(e,t.getOptions()))return i;throw Te.create("already-initialized")}return t.initialize({options:e})}function Sy(n,e,t,r){n=at(n),yy(Ml,En[n.app.options.appId],e,t,r).catch(i=>_e.error(i))}const xa="@firebase/analytics",Fa="0.10.8";function Ry(){De(new Re(Pr,(e,{options:t})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("installations-internal").getImmediate();return wy(r,i,t)},"PUBLIC")),De(new Re("analytics-internal",n,"PRIVATE")),we(xa,Fa),we(xa,Fa,"esm2017");function n(e){try{const t=e.getProvider(Pr).getImmediate();return{logEvent:(r,i,o)=>Sy(t,r,i,o)}}catch(t){throw Te.create("interop-component-reg-failed",{reason:t})}}}Ry();const xl={apiKey:void 0,authDomain:void 0,projectId:void 0,storageBucket:void 0,messagingSenderId:void 0,appId:void 0,measurementId:void 0},Cs=tc(xl),Fl=op(Cs);am(Cs);Ay(Cs);window.addEventListener("online",async()=>{try{await cp(Fl),console.log("🔥 Firebase: Back online")}catch(n){console.error("Firebase network enable error:",n)}});window.addEventListener("offline",async()=>{try{await lp(Fl),console.log("🔥 Firebase: Offline mode")}catch(n){console.error("Firebase network disable error:",n)}});try{console.log("🔥 Firebase initialized successfully with project:",xl.projectId)}catch(n){console.error("Firebase initialization error:",n)}const qi=Ou.API_BASE;console.log("API_BASE ->",qi||"(same-origin)");const Dt=[{name:"Sarah",comment:"🔥 Best ramen spot ever!",emoji:"🍜",avatar:"https://i.pravatar.cc/80?img=32"},{name:"James",comment:"💯 Always go for the sushi here",emoji:"🍣",avatar:"https://i.pravatar.cc/80?img=12"},{name:"Aisha",comment:"👌 Perfect comfort food when tired",emoji:"🍲",avatar:"https://i.pravatar.cc/80?img=58"}],Cy=6;let wi=JSON.parse(localStorage.getItem("vfied_recent")||"[]");function Py(n){n&&(wi=[n,...wi.filter(e=>e.toLowerCase()!==n.toLowerCase())].slice(0,Cy),localStorage.setItem("vfied_recent",JSON.stringify(wi)))}let rt=[],Cn={},zi=[];document.addEventListener("DOMContentLoaded",()=>{Qy(),Wy(),ky(),zy(),My(),Fy(),jy(),Hy(),zl(),console.log("🚀 VFIED unified main loaded")});function ky(){const n=j("decide-button"),e=j("detect-mood-btn"),t=j("accept-btn"),r=j("try-again-btn"),i=j("insights-toggle");n&&n.addEventListener("click",Vn),e&&e.addEventListener("click",Gy),t&&t.addEventListener("click",Ly),r&&r.addEventListener("click",Vy),i&&i.addEventListener("click",()=>{const h=j("insights-content");h.classList.contains("hidden")?(h.classList.remove("hidden"),i.textContent="🤖 Hide insights ↑"):(h.classList.add("hidden"),i.textContent="🤖 Why this choice? ↓")});const o=j("see-more-gems"),c=j("gems-modal"),u=j("gems-modal-close");o&&o.addEventListener("click",()=>{By(),Xy(c)}),u&&u.addEventListener("click",()=>$a(c)),c&&c.addEventListener("click",h=>{h.target===c&&$a(c)})}function Ua(n,e=!0){try{const t=n||document.getElementById("decide-button");if(!t)return;t.disabled=!!e;const r=document.getElementById("button-icon"),i=document.getElementById("button-text");e?(r&&(r.textContent="⏳"),i&&(i.textContent="Thinking…")):(r&&(r.textContent="🎯"),i&&(i.textContent="DECIDE FOR ME"))}catch(t){console.warn("setThinking failed:",t)}}function Oy(){return{city:"London",country:"United Kingdom",country_code:"GB"}}function Dy(n){var r;const e=(r=n.food)==null?void 0:r.name;if(!e)return[];let t=JSON.parse(localStorage.getItem("vfied_recent")||"[]");return t=t.filter(i=>i.toLowerCase()!==e.toLowerCase()),t.unshift(e),t=t.slice(0,8),localStorage.setItem("vfied_recent",JSON.stringify(t)),console.log("📝 Updated recent suggestions:",t),t}function Ny(n){return n>=6&&n<11?"breakfast":n>=11&&n<15?"lunch":n>=15&&n<18?"snack":n>=18&&n<22?"dinner":"late_night"}async function Vn(){var e,t,r;const n=document.getElementById("decide-button");Ua(n,!0);try{const i=((t=(e=document.getElementById("mood-input"))==null?void 0:e.value)==null?void 0:t.trim())||"",o=Array.from(document.querySelectorAll(".diet-chip.active")).map(f=>f.dataset.diet);console.log("🎯 Making decision with:",{mood:i,dietary:o});const c=JSON.parse(localStorage.getItem("vfied_recent")||"[]"),u=await fetch("".concat(qi,"/v1/quick_decision"),{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({location:Oy(),mood_text:i,dietary:o,recent_suggestions:c,time_context:{current_hour:new Date().getHours(),meal_period:Ny(new Date().getHours()),is_weekend:[0,6].includes(new Date().getDay())}})});if(!u.ok){const f=await u.text();throw new Error("HTTP ".concat(u.status,": ").concat(f))}const h=await u.json();if(console.log("📥 Server response:",h),h.success&&h.decisions){const f=h.decisions[Math.floor(Math.random()*h.decisions.length)],I={food:{name:f.name,emoji:f.emoji||"🍽️"},friendMessage:f.explanation||"Perfect choice for you right now!",source:h.source||"server",confidence:85},A=ja(I);Ba(A),Dy(I),Ky({timeSavedMin:3})}else throw new Error(h.error||"No decisions returned")}catch(i){console.error("❌ Decision error:",i);const o=ja({food:{name:"Something Good",emoji:"🍽️"},friendMessage:"Server unavailable - try any local favorite!",source:"client_fallback"});Ba(o),Ht("Connection issue: ".concat(i.message),"warn")}finally{Ua(n,!1)}console.log("🔍 Client debug:",{api_base:qi,mood_input_value:(r=document.getElementById("mood-input"))==null?void 0:r.value,selected_dietary:Array.from(document.querySelectorAll(".diet-chip.active")).map(i=>i.dataset.diet)})}function Ba(n){var e,t,r;Jy("suggestion-result"),gt("result-emoji",((e=n.food)==null?void 0:e.emoji)||"🍽️"),gt("result-name",((t=n.food)==null?void 0:t.name)||"Something delicious"),gt("result-description",n.friendMessage||n.reasoning||"Perfect for your mood!"),gt("restaurant-info",n.availabilityNote||""),Ai("cultural-note",n.culturalNote?"<strong>🌍 Cultural insight</strong><br>".concat(n.culturalNote):""),Ai("personal-note",n.personalNote?"<strong>🧠 Personal note</strong><br>".concat(n.personalNote):""),Ai("weather-note",n.weatherNote?"<strong>🌤️ Weather</strong><br>".concat(n.weatherNote):""),xy(n),Kl("🎉 Perfect match found! How does this sound?"),Py((r=n.food)==null?void 0:r.name)}function Ly(){Gl("suggestion-result"),Kl("🎉 Decision made! Ready for your next food adventure."),Ht("✅ Enjoy your meal!","success")}function Vy(){Gl("suggestion-result"),Vn()}function My(){const n=j("friend-chips");n&&(n.innerHTML="",Dt.forEach(e=>{const t=document.createElement("button");t.className="friend-chip",t.innerHTML='\n      <img class="friend-avatar" src="'.concat(e.avatar,'" alt="').concat(qt(e.name),'" />\n      <span>').concat(e.emoji," <strong>").concat(qt(e.name),"</strong></span>\n    "),t.addEventListener("click",()=>Ul(e.name)),n.appendChild(t)}))}function Ul(n){const e=Dt.find(r=>r.name===n);if(!e)return;Ht("💬 Asking ".concat(e.name,': "').concat(e.comment,'"'),"info");const t=j("mood-input");t&&(e.emoji==="🍜"?t.value="need something warming and comforting":e.emoji==="🍣"?t.value="feeling adventurous, want something fresh":t.value="need comfort food")}function ja(n){var r;const e=(((r=n.food)==null?void 0:r.name)||"").toLowerCase();let t=Dt[Math.floor(Math.random()*Dt.length)];if((e.includes("ramen")||e.includes("noodle"))&&(t=Dt[0]),(e.includes("sushi")||e.includes("japanese"))&&(t=Dt[1]),n.socialSignal={type:"friend",friend:t,message:"".concat(t.name,': "').concat(t.comment,'"')},rt.length){const i=rt[Math.floor(Math.random()*rt.length)];n.localSignal={type:"local_list",list:i,message:'Popular in "'.concat(i.name,'" (').concat(i.area,")")}}return n}function xy(n){const e=j("social-signals");if(!e)return;let t="";n.socialSignal&&(t+='\n      <div class="social-signal friend-signal">\n        <span class="signal-icon">👥</span>\n        <span class="signal-text">'.concat(n.socialSignal.message,"</span>\n      </div>")),n.localSignal&&(t+='\n      <div class="social-signal local-signal">\n        <span class="signal-icon">📍</span>\n        <span class="signal-text">'.concat(n.localSignal.message,"</span>\n      </div>")),e.innerHTML=t}async function Fy(){try{rt=await(await fetch("/data/local_lists.json",{cache:"no-store"})).json()}catch(n){rt=[]}Uy()}function Uy(){const n=j("local-gems-grid");if(!n)return;const e=rt.slice(0,8);n.innerHTML="",e.forEach(t=>{const r=document.createElement("div");r.className="gem-card",r.innerHTML='\n      <div class="gem-emoji">'.concat(t.emoji,'</div>\n      <div class="gem-name">').concat(qt(t.name),'</div>\n      <div class="gem-area">').concat(qt(t.area),"</div>\n    "),r.addEventListener("click",()=>Bl(t.name)),n.appendChild(r)})}function Bl(n){const e=rt.find(r=>r.name===n);if(!e)return;const t=j("mood-input");t&&(t.value="want something from ".concat(e.name," list in ").concat(e.area)),Vn()}function By(){const n=j("gems-modal-list");n&&(n.innerHTML=rt.map(e=>'\n      <li>\n        <span style="font-size:18px;margin-right:6px;">'.concat(e.emoji,"</span>\n        <strong>").concat(e.name,'</strong> <span style="opacity:.8">• ').concat(e.area,"</span>\n      </li>")).join(""))}async function jy(){try{Cn=await(await fetch("/data/travel_lists.json",{cache:"no-store"})).json()}catch(n){Cn={}}$y(),jl()}function $y(){const n=j("travel-city-select");if(!n)return;const e=Object.keys(Cn);n.innerHTML=e.map(t=>'<option value="'.concat(t,'">').concat(t,"</option>")).join(""),n.addEventListener("change",()=>jl())}function jl(){var r;const n=((r=j("travel-city-select"))==null?void 0:r.value)||Object.keys(Cn)[0],e=(Cn[n]||[]).slice(0,10),t=j("travel-grid");t&&(t.innerHTML="",e.forEach(i=>{const o=document.createElement("div");o.className="travel-card",o.innerHTML='\n      <div class="travel-emoji">'.concat(i.emoji,'</div>\n      <div class="travel-body">\n        <div class="travel-title">').concat(qt(i.name),'</div>\n        <div class="travel-note">').concat(qt(i.note||""),"</div>\n      </div>\n    "),o.addEventListener("click",()=>$l(n,i.name)),t.appendChild(o)}))}function $l(n,e){const t=j("mood-input");t&&(t.value="travel mode: try ".concat(e," in ").concat(n)),Vn()}async function Hy(){try{zi=await(await fetch("/data/events.json",{cache:"no-store"})).json()}catch(n){zi=[]}qy()}function qy(){const n=j("events-grid");n&&(n.innerHTML="",zi.forEach(e=>{const t=document.createElement("div");t.className="event-card";const r=document.createElement("div");r.className="event-badge",r.textContent=e.emoji;const i=document.createElement("div");i.className="event-body";const o=document.createElement("div");o.className="event-title",o.textContent=e.title;const c=document.createElement("div");c.className="event-meta",c.textContent="".concat(e.date," • ").concat(e.area," • ").concat(e.price||"Free");const u=document.createElement("div");u.className="event-cta";const h=document.createElement("button");h.className="insights-toggle",h.textContent="Details",h.addEventListener("click",()=>Hl(e.title));const f=document.createElement("button");f.className="insights-toggle",f.textContent="Directions",f.addEventListener("click",()=>ql(encodeURIComponent(e.map||e.title))),u.append(h,f),i.append(o,c,u),t.append(r,i),n.appendChild(t)}))}function Hl(n){Ht("🎪 ".concat(n,"\n(Integrate ticket link or detail view here)"),"info")}function ql(n){window.open("https://www.google.com/maps/search/?api=1&query=".concat(n),"_blank")}function zy(){document.querySelectorAll(".tab-btn").forEach(n=>{n.addEventListener("click",()=>{var t;document.querySelectorAll(".tab-btn").forEach(r=>r.classList.remove("active")),n.classList.add("active");const e=n.dataset.tab;document.querySelectorAll(".tabpanel").forEach(r=>r.classList.add("hidden")),(t=j(e))==null||t.classList.remove("hidden")})})}function Gy(){var t;const n=j("mood-input");if(!((t=n==null?void 0:n.value)==null?void 0:t.trim()))return Ht("🧠 Please enter your mood first!","warn");Ht("🧠 Mood analyzed — using it in your next suggestion!","info"),Vn()}function Ky({timeSavedMin:n=2}={}){const e=localStorage.getItem("vfied_stats"),t=e?JSON.parse(e):{totalDecisions:0,timeSaved:0};t.totalDecisions+=1,t.timeSaved+=n,localStorage.setItem("vfied_stats",JSON.stringify(t)),zl()}function zl(){const n=localStorage.getItem("vfied_stats"),e=n?JSON.parse(n):{totalDecisions:0,timeSaved:0};gt("decisions-count",e.totalDecisions),gt("time-saved",e.timeSaved)}function Wy(){if(j("vfied-toast-host"))return;const n=document.createElement("div");n.id="vfied-toast-host",document.body.appendChild(n)}function Ht(n,e="info"){const t=j("vfied-toast-host");if(!t)return console.log(n);const r=document.createElement("div");r.className="vfied-toast ".concat(e),r.textContent=n,t.appendChild(r),requestAnimationFrame(()=>r.classList.add("show")),setTimeout(()=>{r.classList.remove("show"),setTimeout(()=>t.removeChild(r),250)},2600)}function Qy(){if(document.getElementById("vfied-runtime-styles"))return;const n="\n  #vfied-toast-host {\n    position: fixed; left: 50%; bottom: 24px; transform: translateX(-50%);\n    display: flex; flex-direction: column; gap: 8px; z-index: 9999; pointer-events: none;\n  }\n  .vfied-toast {\n    pointer-events: auto;\n    min-width: 240px; max-width: 92vw;\n    padding: 10px 14px; border-radius: 10px; backdrop-filter: blur(8px);\n    background: rgba(0,0,0,.65); color: #fff; font-weight: 600; font-size: 14px;\n    opacity: 0; transform: translateY(8px); transition: all .25s ease;\n    border: 1px solid rgba(255,255,255,.15);\n  }\n  .vfied-toast.show { opacity: 1; transform: translateY(0); }\n  .vfied-toast.success { background: rgba(34,197,94,.85); }\n  .vfied-toast.warn { background: rgba(245,158,11,.9); }\n  .vfied-toast.error { background: rgba(239,68,68,.9); }\n\n  .skeleton-card {\n    background: rgba(255,255,255,.12); border: 1px solid rgba(255,255,255,.18);\n    border-radius: 16px; padding: 18px; max-width: 420px; margin: 8px auto;\n  }\n  .sk-line {\n    height: 14px; margin: 10px 0;\n    background: linear-gradient(90deg, rgba(255,255,255,.15), rgba(255,255,255,.25), rgba(255,255,255,.15));\n    background-size: 200% 100%; animation: sk-shimmer 1.4s infinite;\n    border-radius: 8px;\n  }\n  .sk-emoji { height: 46px; width: 46px; border-radius: 50%; margin: 0 auto 10px; }\n  .sk-title { height: 18px; width: 70%; margin: 12px auto; }\n  .sk-sub { width: 90%; margin: 10px auto; }\n  .sk-sub.short { width: 60%; }\n  @keyframes sk-shimmer { 0% { background-position: 200% 0; } 100% { background-position: -200% 0; } }\n\n  /* Friend avatar chip (if your CSS doesn't already style it) */\n  .friend-chip { display:inline-flex; align-items:center; gap:8px; }\n  .friend-avatar { width:22px; height:22px; border-radius:50%; object-fit:cover; }\n  ",e=document.createElement("style");e.id="vfied-runtime-styles",e.textContent=n,document.head.appendChild(e)}function j(n){return document.getElementById(n)}function gt(n,e){const t=j(n);t&&(t.textContent=e)}function Ai(n,e){const t=j(n);t&&(t.innerHTML=e)}function Jy(n){const e=j(n);e&&e.classList.remove("hidden")}function Gl(n){const e=j(n);e&&e.classList.add("hidden")}function Kl(n){gt("context-info",n)}function qt(n){return String(n).replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[e])}function Xy(n){n&&(n.setAttribute("aria-hidden","false"),n.classList.add("open"))}function $a(n){n&&(n.setAttribute("aria-hidden","true"),n.classList.remove("open"))}window.VFIED={askFriend:Ul,exploreGem:Bl,tryTravel:$l,goEvent:Hl,goMaps:ql};export{Yy as __vite_legacy_guard};
//# sourceMappingURL=index-BRavssnh.js.map
